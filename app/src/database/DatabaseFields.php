...
trait DatabaseFields
{
    ...
    public static function timeField($onUpdate = false, $null = false, $defaultValue = 'CURRENT_TIMESTAMP') : array {
        $onUpdate = $onUpdate ? 'on update CURRENT_TIMESTAMP' : '';
        $attributes =   [
            'type' => 'TIME',
            'onUpdate' => $onUpdate,
    ...
    public static function dateField($onUpdate = false, $null = false, $defaultValue = 'CURRENT_TIMESTAMP') : array {
        $onUpdate = $onUpdate ? 'on update CURRENT_TIMESTAMP' : '';
        $attributes =   [
            'type' => 'DATE',
            'onUpdate' => $onUpdate,
    ...
    public static function yearField($onUpdate = false, $null = false, $defaultValue = 'CURRENT_TIMESTAMP') : array {
        $onUpdate = $onUpdate ? 'on update CURRENT_TIMESTAMP' : '';
        $attributes =   [
            'type' => 'YEAR',
            'onUpdate' => $onUpdate,
    ...
    public static function uniqueStringField(int $length = CHAR_LENGTH, $null = false, $defaultValue = null) : array {
        $attributes =   [
            'type' => "VARCHAR({$length})",
            'null' => self::null($null),
            'default' => self::default($defaultValue),
    ...
    public static function stringField(int $length, $null = false, $defaultValue = null, $unique = false) : array {
        $attributes =  [
            'type' => "VARCHAR({$length})",
            'null' => self::null($null),
            'default' => self::default($defaultValue)
